...
# The vendor stage intentionally contains only Composer manifests. Laravel's

# post-autoload script invokes artisan, which is unavailable until the source

# tree is copied into the final application image.
